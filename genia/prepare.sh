...
# done
# sleep 3
[[ -f "bio_nlp_vec.tar.gz" ]] || echo "bio_nlp_vec.tar.gz was not downloaded."
[[ -f "biobert_large_v1.1_pubmed.tar.gz" ]] || echo "biobert_large_v1.1_pubmed.tar.gz was not downloaded."
if [[ ! -f "bio_nlp_vec.tar.gz" ]] || [[ ! -f "biobert_large_v1.1_pubmed.tar.gz" ]]; then
    exit 1
fi
